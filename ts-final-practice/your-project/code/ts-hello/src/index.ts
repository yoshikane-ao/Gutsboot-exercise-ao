...
console.log(strings, booleans, nulls, undefineds);
  ...
  //2問目
const consts1: string = "const1";
const consts2: string = "const2";
let i: string = "i";
i = "aiueo";
console.log(i);
...
console.log("evens", result);
  ...
  //4問目
const first_number: number[] = [1, 2, 3, 4, 5, 6, 7, 8, 9];
